...
# Default DB name for this app
	define('DB_NAME', 'p2_wingsthings_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', '!IBqFEXjqpemUKg(PPPIgaCy)hekY!TvI@7PKXRj');
	define('TOKEN_SALT', '1C4&cre1(!UUV^Xe4TWk#FWv9S8QR9p0xYDd*on4');
